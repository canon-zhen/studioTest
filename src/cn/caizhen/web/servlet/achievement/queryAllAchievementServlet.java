...
@WebServlet(name = "queryAllAchievementServlet", value = "/queryAllAchievementServlet")
public class queryAllAchievementServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Achievement> achievements = workhomeService.findAllAchievement();
        //将list存入request域
